...
// const getAddress = data.map((items) => {
...
// const names = api.data.map((item) => {
//   return item.name;
// });

// console.log(names);

//  versi 2 function declaration
...
// versi 3 function expression

// const getNames = (param) => {
//   return param.data.map((item) => {
//     return item.name;
//   });
// };

// console.log(getNames(api));
...
//   const dataFilter = param.filter((items) => {
//     return items.subject.score > 70;
//   });
//   const dataMap = dataFilter.map((items) => {
//     return items.subject.score;
//   });
